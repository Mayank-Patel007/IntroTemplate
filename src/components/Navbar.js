...
function Navbar() {
    ...
    return (
        <div>
            <div className='flex justify-between w-full py-8 px-4 md:px-64'>
                ...
                <div className='flex items-center'>
                    <div className='md:hidden'>
                        <IoMdMenu className='h-8 w-8 text-black cursor-pointer' onClick={() => setMenuOpen(!menuOpen)} />
                    </div>
                    <div className='hidden md:flex gap-2 space-x-4'>
                        <Link to='/' className='hover:text-orange-400 hover:cursor-pointer'>Home</Link>
                        <Link to='/new' className='hover:text-orange-400 hover:cursor-pointer'>New</Link>
                        <Link to='/popular' className='hover:text-orange-400 hover:cursor-pointer'>Popular</Link>
                        <Link to='/trending' className='hover:text-orange-400 hover:cursor-pointer'>Trending</Link>
                        <Link to='/categories' className='hover:text-orange-400 hover:cursor-pointer'>Categories</Link>
                    </div>
                </div>
                {menuOpen && (
